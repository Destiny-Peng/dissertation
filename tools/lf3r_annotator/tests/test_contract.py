...
class DatasetAndFrontendContractTest(unittest.TestCase):
    ...
    def test_workspace_navigation_settings_and_analysis_contract(self) -> None:
        ...
        for marker in [
            ...
            "Failed-rollout localization · no clean-FPR constraint",
            "Failed-rollout interval localization",
            "analysisHopPointRankPopulation",
            "analysisHopPointRankSort",
            "analysisHopPointRankDirection",
            "analysisHopPointRankLimit",
