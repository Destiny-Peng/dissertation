...
(function installResultsAxisScale() {
  if (typeof window.renderSignalChart !== "function") return;
  ...
  function renderSignalChartFixed(method, result, record) {
  ...
  renderSignalChartFixed.__lf3rFixedValueAxes = true;
  window.renderSignalChart = renderSignalChartFixed;
})();
