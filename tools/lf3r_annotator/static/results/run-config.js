...
(function installResultsRunConfigurator() {
  ...
  var FIELDS = {
    ...
    robo_dopamine: {
      core: [
        ...
        { key: "robo_camera_mode", label: "Camera input", type: "select", defaultValue: "auto", options: [["auto", "Auto · multiview when available"], ["multi_view", "Multiview · cam_high + cam_wrist"], ["single_view", "Single view · canonical video"]] }
      ],
      advanced: [
        { key: "model_path", label: "Model path", type: "text", placeholder: "Use configured checkpoint" },
        { key: "dtype", label: "Dtype", type: "text", defaultValue: "bf16" },
